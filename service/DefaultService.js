...
exports.resolve = function(identifier,accept) {
  return new Promise(function(resolve, reject) {
    const nodeURL = process.env.sidetree_cardano_node_url ? process.env.sidetree_cardano_node_url : 'https://mnwbfd1eg2.execute-api.us-east-1.amazonaws.com/cardano'; 
